    ...
    return (
        ...
        <div className="w-6/12 p-8">
            ...
            <div className="flex justify-end space-x-1 mb-6">
                <Link href="/keeper/keeper-lobby" className="text-black-600 bg-purple-200 p-3 rounded">
                    Inicio
                </Link>
            ...
            <div className="flex items-start justify-center min-h-screen pt-20">
                <div className="text-white text-center">
                    ...
                    <p className="my-4 text-gray-600">Bienvenido Cuidador, ¿preparado para la aventura?</p>
                </div>
            </div>
