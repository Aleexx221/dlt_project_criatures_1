...
import { saveCreature } from '@/lib/action';

const CrearCriaturasMaster: React.FC = () => {
    const [state, formAction] = useFormState(saveCreature, null);
    return (
            ...
            <div className="w-5/6 p-8 flex flex-col justify-start"> {/* Cambiado para justificar al inicio */}
                ...
                <div className="flex flex-col items-center mb-8 space-y-4">
                    ...
                    <form action={formAction}>
                        ...
                        <div className='mx-3'>
                            <Link href="/master/master-lista-criaturas">
                                <button className="bg-purple-600 text-white font-bold py-4 px-6 rounded-md hover:bg-purple-700 transition-colors duration-300">
                                    Volver
                                </button>
                            </Link>
...
export default CrearCriaturasMaster;